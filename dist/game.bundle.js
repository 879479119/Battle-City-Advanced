...
var _Manager2 = __webpack_require__(21);
...
var requireContext = __webpack_require__(11);
...
var _judge = __webpack_require__(24);
...
var _EditorGrid = __webpack_require__(18);

var _EditorGrid2 = _interopRequireDefault(_EditorGrid);

var _ProfileGrid = __webpack_require__(20);
...
var _EnemyBase = __webpack_require__(8);

var _EnemyBase2 = _interopRequireDefault(_EnemyBase);

var _EnemyController = __webpack_require__(22);

var _EnemyController2 = _interopRequireDefault(_EnemyController);

var _FireManager = __webpack_require__(14);
...
var _Tank2 = __webpack_require__(9);

var _Tank3 = _interopRequireDefault(_Tank2);

var _EnemyFire = __webpack_require__(13);
...
var _Canvas2 = __webpack_require__(5);
...
var EditorGrid = function (_Grid) {
	...
	function EditorGrid() {
		...
		_this.activePicker = [94, 40, "walls", 1];
		_this.key_down = false;
		_this.giantBlock = false;
		//noinspection JSUnresolvedVariable
		_this.game = props[2];
		_this.mode = [52, 47, "select", 3]; //select rect area or pencil
	...
	_createClass(EditorGrid, [{
		...
		value: function init(map, canvas) {
			...
			this.partner = canvas;
			this.startPicker();
			this.drawToolBorder.apply(this, _toConsumableArray(this.activePicker).concat([true]));
			this.drawToolBorder.apply(this, _toConsumableArray(this.mode).concat([true]));
		}
	}, {
    ...
    */
		...
		value: function drawItem() {
			...
			var _map$changeItem = map.changeItem(sX, sY, this.activePicker[2]),
			    x = _map$changeItem.x,
			    y = _map$changeItem.y;
		...
		key: 'drawToolBorder',
		value: function drawToolBorder(col, row, name, type) {
		...
		key: 'rectStroke',
		value: function rectStroke(color, width, col, row) {
			...
			var fnMouseMove = function fnMouseMove(e) {
				...
				if (dX >= 0 && dX <= map.width * step && dY >= 0 && dY <= map.height * step) {
					...
					if (_this4.key_down === true && _this4.giantBlock === false) {
						...
						if (_this4.mode[2] === "select") {
							_this4.partner.drawSelection(col, row);
						} else {
							//TODO
							_this4._drawBlock(row, col, EditorGrid.MAPPER[_this4.activePicker[2]][0]);
							_this4.map.changeBlock(col, row, EditorGrid.MAPPER[_this4.activePicker[2]][1]);
						}
					} else {
			...
			var fnClick = function fnClick(e) {
				...
				EditorGrid.PICKER.map(function (item) {
					if ((item[0] - 1) * step < x && (item[0] + 3) * step > x && (item[1] - 1) * step < y && (item[1] + 3) * step > y) {
						...
						_this4.drawToolBorder.apply(_this4, _toConsumableArray(item));

						switch (item[3]) {
							case 1:
								_this4.activePicker = item;
		...
		key: 'PICKER',
		get: function get() {
			return [[72, 47, "bin", 1], [22, 47, "save", 3], [32, 47, "quit", 3], [42, 47, "pencil", 3], [52, 47, "select", 3], [62, 47, "revoke", 3], [4, 10, "base", 2], [4, 20, "p1tankU", 2], [4, 30, "p2tankF", 2], [4, 40, "enemy1", 2], [94, 10, "steels", 1], [94, 20, "grass", 1], [94, 30, "water", 1], [94, 40, "walls", 1]];
		}
	}, {
		key: 'MAPPER',
		get: function get() {
...
var _DetailGrid = __webpack_require__(16);
...
var _DummyGrid = __webpack_require__(17);
...
var _PlayerFire = __webpack_require__(15);
